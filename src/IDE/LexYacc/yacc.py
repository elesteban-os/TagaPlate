...
from LexYacc.lexer1 import tokens, getLexErrorsList, clearLexErrors
...
# error
def p_error(p):
    text = "Error de sintaxis '" + p.value + "' en la línea: " + str(p.lineno)
    print(text)
